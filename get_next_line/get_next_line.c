...
/*   Updated: 2018/12/26 16:58:11 by fshanaha         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "get_next_line.h"

t_list	*ft_search_list(int fd, t_list *list)
{
	t_list	*buff;
...
int		ft_newline(t_list **bufl, char **line)
{
	char	*buff;
	int		corr;
...
t_list	*ft_mod_list(int fd, char *buff, t_list **list)
{
	char	*storage;
	t_list	*save;
...
void	ft_dellist(t_list **list, int fd)
{
	t_list	*first;
	t_list	*second;
